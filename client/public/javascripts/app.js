...
with (locals || {}) {
var interp;
buf.push('<div id="content"><input type="file" name="bookmarks-file" id="bookmarks-file"/><span class="import"><button title="import html bookmarks files exported from your browser" class="icon icon-upload icon-import"></button><p class="imported"></p><p class="importe-failed"></p></span><span class="export"><button title="export bookmarks in html" class="icon icon-download icon-export"></button></span><form id="create-bookmark-form"><h1 title="click to show the full form" class="title"><span>Bookmark a link</span><input title="click to show the full form" placeholder="url" class="url-field"/></h1><div class="full-form"><p><input placeholder="title" class="title-field"/><input placeholder="tags, separated by \',\'" class="tags-field"/></p><p class="last"><textarea placeholder="description" class="description-field"></textarea></p><div class="buttons"><button title="click here to store the bookmark" class="create"><img src="icons/add.png" alt="add"/></button><button title="click to clean the form" class="clean"><img src="icons/clean.png" alt="clean"/></button></div></div></form><div id="bookmark-list"><h1 class="title">mY BOOkmarks</h1><div class="tools"><input placeholder="search" class="search"/><button title="click to sort links" data-sort="title" class="sort descending"><img src="icons/sort-descending.png" alt="sort"/></button></div><ul class="list"></ul></div></div>');
}
return buf.join("");
};
});
